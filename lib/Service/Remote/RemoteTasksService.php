...
class RemoteTasksService
{
    ...
    public function updateFieldExtendedByName(string $collection, string $name, string $type, mixed $value): object
    {
        ...
        // create field task object
        $o->Task = new TaskType();
        $o->Task->ExtendedProperty = new ExtendedPropertyType(
            new PathToExtendedFieldType(
                $collection,
                null,
                null,
    ...
    public function constructTimeZone(string $name): object
    {
        ...
        if (!empty($zone->StandardBias) && !empty($zone->DaylightBias)) {
            ...
            $group = new ArrayOfTransitionsType();
            $group->Id = 0;
            ...
            $o->Transitions->Transition->To = new TransitionTargetType();
