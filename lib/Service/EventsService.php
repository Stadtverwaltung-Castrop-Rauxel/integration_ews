...
use OCA\EWS\Service\Remote\RemoteEventsService2007;
...
class EventsService
{
    ...
    public function __construct(string                      $appName,
                                ...
                                private CalDavBackend       $LocalStore,
    ...
    public function configure($configuration, EWSClient $RemoteStore): void
    {
        ...
        switch ($RemoteStore->getVersion()) {
            ...
            case $RemoteStore::SERVICE_VERSION_2009:
                $this->RemoteEventsService = \OC::$server->get(RemoteEventsService2007::class);
                break;
            default:
                $this->RemoteEventsService = \OC::$server->get(RemoteEventsService::class);
                break;
        }
