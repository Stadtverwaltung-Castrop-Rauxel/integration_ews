...
use OCA\EWS\Service\Remote\RemoteTasksService2007;
    ...
    public function configure($configuration, EWSClient $RemoteStore): void
    {
        ...
        switch ($RemoteStore->getVersion()) {
            ...
            case $RemoteStore::SERVICE_VERSION_2009:
                $this->RemoteTasksService = \OC::$server->get(RemoteTasksService2007::class);
                break;
            default:
                $this->RemoteTasksService = \OC::$server->get(RemoteTasksService::class);
                break;
        }
